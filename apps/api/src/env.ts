  ...
  return {
    ...
    promptGeneration: {
      ...
      drive: {
        ...
        // All four are required together: three credentials and a destination.
        // A partially configured Drive would fail on the first upload, which is
        // the worst moment to discover it.
        live:
          envNonEmpty('GOOGLE_OAUTH_CLIENT_ID') &&
          envNonEmpty('GOOGLE_OAUTH_CLIENT_SECRET') &&
          envNonEmpty('GOOGLE_OAUTH_REFRESH_TOKEN') &&
          envNonEmpty('GOOGLE_DRIVE_FOLDER_ID'),
